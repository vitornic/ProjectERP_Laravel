            ...
            <div class="card-body card" style="width: 38drem;">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="codLancamento" name="codLancamento" value="{{ $operacoes->id }}" readonly>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="descricao">{{ __('Descrição') }}</label>
                        <input type="text" class="form-control" id="descricao" name="descricao" value="{{ $operacoes->descricao }}" autocomplete="descricao" autofocus>
                    </div>
                    <div class="form-group col-md-4">
